          ...
          >
            ...
            <ul class="mt-4 space-y-2">
              <li class="flex items-center gap-2 rounded-lg bg-surface-100 p-2 dark:bg-slate-900">
                <strong class="rounded-full bg-primary px-3 py-1 text-sm text-white">1st</strong>
                <span class="ml-auto">50%</span>
              </li>
              <li class="flex items-center gap-2 rounded-lg bg-surface-100 p-2 dark:bg-slate-900">
                <strong class="rounded-full bg-primary/15 px-3 py-1 text-sm text-primary">2nd</strong>
                <span class="ml-auto">25%</span>
              </li>
              <li class="flex items-center gap-2 rounded-lg bg-surface-100 p-2 dark:bg-slate-900">
                <strong class="rounded-full bg-primary/15 px-3 py-1 text-sm text-primary">3rd</strong>
                <span class="ml-auto">12.5%</span>
              </li>
              <li class="flex items-center gap-2 rounded-lg bg-surface-100 p-2 dark:bg-slate-900">
                <strong class="rounded-full bg-primary/15 px-3 py-1 text-sm text-primary">4th</strong>
                <span class="ml-auto">7.5%</span>
              </li>
              <li class="flex items-center gap-2 rounded-lg bg-surface-100 p-2 dark:bg-slate-900">
                <strong class="rounded-full bg-primary/15 px-3 py-1 text-sm text-primary">5th</strong>
