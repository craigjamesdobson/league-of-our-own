...
<template>
    <DataTable v-if="props.weeklyData" scrollable striped-rows :value="props.weeklyData">
        <Column field="index">
            <template #header="">
        ...
        <Column field="team_name" header="Team">
            <template #body="slotProps">
                <div class="flex gap-2.5">
                    <Button v-tooltip.top="`Show points breakdown`" class="w-8 h-8 !p-1" rounded text
                        aria-label="Team information" @click="showTeamPoints(slotProps.data.drafted_team_id)">
