...
The frontend host is expected to provide the application's runtime and public configuration, including the applicable Supabase URL and key, site URL, active season, Turnstile configuration, email credentials, and service-role credentials. Refer to the configuration reference for the full inventory.
