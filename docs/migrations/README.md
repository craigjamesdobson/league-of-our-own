...
This directory contains procedural documentation for major version upgrades and platform migrations.
...
**Status**: In progress (branch: `upgrade/nuxt-4-migration`)

---

## About This Directory

Migration documentation differs from architectural lessons:

- **Migrations** are time-bound procedural guides for upgrading to new major versions
