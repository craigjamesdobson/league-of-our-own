...
<template>
  <div class="flex flex-col lg:grid lg:grid-cols-6 lg:gap-10">
    ...
    <Dialog class="w-[90%] sm:w-[500px]" pt:header:class="!items-start !pb-2" pt:title:class="uppercase !font-black" pt:content:class="!p-0 !pb-2"
      dismissable-mask v-model:visible="visible" modal :header="`Week ${selectedWeek} score`">
