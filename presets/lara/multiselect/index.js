export default {
  ...
  headerCheckbox: ({ context, state }) => ({
    class: [
      ...
      'text-surface-600',
      {
        'border-surface-200  bg-surface-0 ': !context?.selected,
        'border-primary-500 bg-primary-500 ': context?.selected,
      },

      'hover:border-primary-500',
      {
        'outline-none outline-offset-0 ring-2 ring-primary-400/50 ':
          state.focused,
      },
    ],
  }),
  ...
  checkbox: ({ context }) => ({
    class: [
      ...
      'focus:outline-offset-0 focus:ring focus:ring-primary-400/50 ',
    ],
  }),
  checkboxicon: {
    class: [
