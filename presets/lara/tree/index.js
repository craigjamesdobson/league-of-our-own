export default {
  ...
  node: {
    class: [
      'p-1',
      'rounded-md',
      'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-inset focus:ring-primary-400/50 ',
    ],
  },
  ...
  loadingicon: {
    class: ['text-surface-500 ', 'absolute top-[50%] right-[50%] -mt-2 -mr-2'],
  },
  searchicon: {
    class: [
      // Position
